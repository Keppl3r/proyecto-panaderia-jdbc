...
CREATE TABLE USUARIOS (
    ...
    ROL VARCHAR(20) NOT NULL -- Discriminador para saber si es cliente o empleado
);
...
('Concha de Vainilla', 'DULCE', 'Pan dulce tradicional con cobertura de vainilla', 15.50, TRUE),
('Bolillo', 'SALADO', 'Pan blanco crujiente ideal para tortas', 5.00, TRUE),
('Pan Integral', 'INTEGRAL', 'Pan saludable con harina integral', 20.00, TRUE),
('Cuerno de Mantequilla', 'DULCE', 'Pan hojaldrado con mantequilla', 18.00, TRUE);