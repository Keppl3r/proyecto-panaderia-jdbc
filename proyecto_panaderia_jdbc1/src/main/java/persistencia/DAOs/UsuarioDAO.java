...
public class UsuarioDAO implements IUsuarioDAO {
     ...
     * @param idUsuario El ID del usuario cuya contraseña se modificará.
     * @param passwordEncriptado La nueva contraseña ya cifrada con SHA-256.
     * @return {@code true} si la actualización fue exitosa.
     * @throws PersistenciaException Si ocurre un error en la operación SQL.
     */
    @Override
