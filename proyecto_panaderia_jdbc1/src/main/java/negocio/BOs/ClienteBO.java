...
public class ClienteBO implements IClienteBO {
  ...
  /**
    ...
    /**
     * Obtiene todos los teléfonos registrados para un cliente.
    ...
    /**
     * Reemplaza los teléfonos del cliente: elimina los existentes e inserta los nuevos.
     * @param idUsuario ID del cliente.
     * @param telefonos Nueva lista de teléfonos a guardar.
