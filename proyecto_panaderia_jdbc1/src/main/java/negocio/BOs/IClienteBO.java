...
public interface IClienteBO {
    ...
    /**
     * Obtiene la lista de teléfonos registrados para un cliente.
     * @param idUsuario El ID del usuario/cliente.
     * @return Lista de objetos {@link Telefono} asociados al cliente.
     * @throws NegocioException Si ocurre un error al consultar los teléfonos.
     */
    List<Telefono> obtenerTelefonos(int idUsuario) throws NegocioException;

    /**
     * Reemplaza los teléfonos de un cliente eliminando los existentes e insertando los nuevos.
     * @param idUsuario El ID del usuario/cliente.
     * @param telefonos La nueva lista de teléfonos a guardar.
     * @throws NegocioException Si ocurre un error al actualizar los teléfonos.
     */
